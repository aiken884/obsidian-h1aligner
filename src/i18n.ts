...
const en = {
    ...
    'notice.invalidPatternsBlocked':
        'H1Aligner: fix the invalid exclude patterns before renaming files.',
    'notice.batchSettingsChanged':
        'H1Aligner: settings changed since this preview. Create a new preview before applying renames.',
    // Commands
    ...
    'batch.moreItems': '…and {count} more item(s)',
    'batch.skippedHeader': 'Skipped {count} note(s):',
    'batch.invalidPatterns':
        'Fix the invalid exclude patterns in Settings before applying renames. Preview is still available, but no files will be changed.',
    'batch.group.rename': 'Rename ({count})',
    'batch.group.conflict': 'Conflicts ({count})',
    'batch.group.error': 'Errors ({count})',
    'batch.group.skipped': 'Skipped ({count})',
    'batch.group.excluded': 'These notes are not included in this batch.',
    'batch.reason.locked': 'Frontmatter lock',
    'batch.reason.noH1': 'No first H1',
    'batch.reason.emptyAfterSanitize': 'Filename is empty after sanitising',
    'batch.reason.sameName': 'Already matches the first H1',
    'batch.reason.caseOnly': 'Case-only rename is disabled',
    'batch.reason.collision': 'Target filename already exists',
    'batch.reason.duplicateTarget': 'Duplicate target in this batch',
    'batch.reason.inProgress': 'Already being renamed',
    'batch.reason.error': 'Rename failed: {message}',
    'batch.reason.unknown': 'Unknown error',
    'batch.close': 'Close',
    ...
    'set.exclude.invalid': 'Invalid pattern(s):\n{patterns}',
    'set.exclude.pending':
        'Invalid patterns are not used for new renames. H1Aligner pauses all new renames until every pattern is valid.',
    'set.exclude.active': 'Currently active rules:\n{patterns}',
    'set.exclude.none': 'There are no active exclude rules.',
    'set.exclude.announcement.invalid': 'Exclude patterns contain errors. Renaming is paused.',
    'set.exclude.announcement.valid': 'Exclude patterns are valid. Renaming is available.',
    ...
    'set.tagmove.desc':
        'Still under active development — behavior may change and edge cases may not be fully handled yet. If you are unsure, leave this off. When a rename runs, collect inline #tags from the note body into the "tags" frontmatter property. Warning: depending on the mode below this modifies the note body; the frontmatter block is rewritten (YAML comments inside it are removed); tags are only collected when the rename flow runs, never while you are typing (edit trigger); tag names are moved verbatim and never cleaned up or renamed. Make sure the File Recovery core plugin is enabled before use, and consider testing on a backup or a small folder first.',
...
const zhTW: Record<LocaleKey, string> = {
    ...
    'notice.invalidPatternsBlocked': 'H1Aligner：請先修正無效的排除規則，才能改名檔案。',
    'notice.batchSettingsChanged': 'H1Aligner：預覽後設定已變更，請重新產生預覽再套用改名。',
    ...
    'batch.moreItems': '…還有 {count} 個項目',
    'batch.skippedHeader': '跳過 {count} 篇筆記：',
    'batch.invalidPatterns': '請先到設定修正無效的排除規則再套用改名。仍可預覽，但不會變更任何檔案。',
    'batch.group.rename': '可改名（{count}）',
    'batch.group.conflict': '衝突（{count}）',
    'batch.group.error': '錯誤（{count}）',
    'batch.group.skipped': '略過（{count}）',
    'batch.group.excluded': '這些筆記不會納入本次改名。',
    'batch.reason.locked': 'frontmatter 已鎖定',
    'batch.reason.noH1': '沒有第一個 H1',
    'batch.reason.emptyAfterSanitize': '清理後的檔名為空',
    'batch.reason.sameName': '檔名已和第一個 H1 相同',
    'batch.reason.caseOnly': '已停用只變更大小寫的改名',
    'batch.reason.collision': '目標檔名已存在',
    'batch.reason.duplicateTarget': '本批次有重複目標檔名',
    'batch.reason.inProgress': '正在改名中',
    'batch.reason.error': '改名失敗：{message}',
    'batch.reason.unknown': '未知錯誤',
    'batch.close': '關閉',
    ...
    'set.exclude.invalid': '無效的 pattern：\n{patterns}',
    'set.exclude.pending': '無效的 pattern 不會用於新的改名；所有 pattern 都有效前，H1Aligner 會暫停新的改名操作。',
    'set.exclude.active': '目前生效的規則：\n{patterns}',
    'set.exclude.none': '目前沒有生效的排除規則。',
    'set.exclude.announcement.invalid': '排除規則有錯誤，已暫停改名。',
    'set.exclude.announcement.valid': '排除規則有效，可進行改名。',
    ...
    'set.tagmove.desc':
        '仍在持續開發中——行為可能改變，部分邊界情況可能尚未完全處理。不確定的話請不要開啟。Rename 執行時，把筆記內文的 #tag 整理進 frontmatter 的 tags 屬性。注意：依下方模式，本功能會修改筆記內文；frontmatter 區塊會被重寫（其中的 YAML 註解會被移除）；只在 rename 流程執行時整理，打字中（編輯觸發）絕不執行；tag 名稱原樣搬移，不會自動清理或改名。使用前請先確認已啟用 File Recovery 核心外掛，並建議先在備份或小範圍資料夾測試。',
...
const ja: Record<LocaleKey, string> = {
    ...
    'notice.invalidPatternsBlocked': 'H1Aligner：ファイルをリネームする前に無効な除外パターンを修正してください。',
    'notice.batchSettingsChanged': 'H1Aligner：プレビュー後に設定が変更されました。リネームを適用する前に新しいプレビューを作成してください。',
    ...
    'batch.moreItems': '…ほか {count} 件',
    'batch.skippedHeader': '{count} 件のノートをスキップ：',
    'batch.invalidPatterns': '設定で無効な除外パターンを修正してからリネームを適用してください。プレビューはできますが、ファイルは変更されません。',
    'batch.group.rename': 'リネーム対象（{count}）',
    'batch.group.conflict': '競合（{count}）',
    'batch.group.error': 'エラー（{count}）',
    'batch.group.skipped': 'スキップ（{count}）',
    'batch.group.excluded': 'これらのノートは今回のリネームには含まれません。',
    'batch.reason.locked': 'フロントマターでロック済み',
    'batch.reason.noH1': '最初の H1 がない',
    'batch.reason.emptyAfterSanitize': 'サニタイズ後のファイル名が空',
    'batch.reason.sameName': 'すでに最初の H1 と同じ名前',
    'batch.reason.caseOnly': '大文字小文字のみのリネームは無効',
    'batch.reason.collision': 'リネーム先のファイル名はすでに存在',
    'batch.reason.duplicateTarget': 'この一括処理内でリネーム先が重複',
    'batch.reason.inProgress': 'すでにリネーム中',
    'batch.reason.error': 'リネームに失敗：{message}',
    'batch.reason.unknown': '不明なエラー',
    'batch.close': '閉じる',
    ...
    'set.exclude.invalid': '無効なパターン：\n{patterns}',
    'set.exclude.pending': '無効なパターンは新しいリネームには使用されません。すべてのパターンが有効になるまで、H1Aligner は新しいリネームを停止します。',
    'set.exclude.active': '現在有効なルール：\n{patterns}',
    'set.exclude.none': '現在有効な除外ルールはありません。',
    'set.exclude.announcement.invalid': '除外パターンにエラーがあります。リネームを停止しました。',
    'set.exclude.announcement.valid': '除外パターンは有効です。リネームできます。',
    ...
    'set.tagmove.desc':
        '現在も開発中の機能です — 動作は変更される可能性があり、一部のエッジケースはまだ完全に対応していません。不安な場合はオフのままにしてください。リネーム実行時に、ノート本文の #タグ を frontmatter の tags プロパティへまとめます。注意：下のモードによっては本文が変更されます。frontmatter ブロックは書き直され、その中の YAML コメントは失われます。タグの整理はリネーム処理の実行時のみ行われ、入力中（編集トリガー）には実行されません。タグ名はそのまま移動され、自動整形やリネームは行いません。使用前に File Recovery コアプラグインが有効なことを確認し、バックアップまたは小規模なフォルダでまず試すことをお勧めします。',
